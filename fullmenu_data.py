...
intel_briefs = [
    {'name': 'NASA Conference', 'personnel_req': 20, 'sat_req': [], 'color': 'acq', 'desc': 'Attend a NASA conference to study new satellite technology.'},
...
#ACQUISITIONS
acq_data = [
    {'name': 'GPS', 'money_cost': 10000, 'personnel_req': 15, 'desc': 'A satellite made for navigation and location based purposes.'},
